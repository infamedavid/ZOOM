...
AUDIO_TOOL_PROPERTIES = {
    'volume': {
        'prop': 'volume',
        'sens_pm': config.PLUS_MINUS_SENSITIVITY_VOLUME,
        'sens_jog': config.JOG_SENSITIVITY_VOLUME,
        'snap_threshold': config.SNAP_THRESHOLD_VOLUME,
        'snap_default': 1.0
    },
    'pan': {
        'prop': 'pan',
        'sens_pm': config.PLUS_MINUS_SENSITIVITY_PAN,
        'sens_jog': config.JOG_SENSITIVITY_PAN,
        'snap_threshold': config.SNAP_THRESHOLD_PAN,
        'snap_default': 0.0
    },
}
