...
OPTICS_TOOL_PROPERTIES = {
    'focal_length': {'prop': 'lens', 'sens_jog': config.JOG_SENSITIVITY_LENS, 'sens_pm': config.PLUS_MINUS_SENSITIVITY_LENS, 'min': 1.0},
    'shift_x':      {'prop': 'shift_x', 'sens_jog': config.JOG_SENSITIVITY_SHIFT, 'sens_pm': config.PLUS_MINUS_SENSITIVITY_SHIFT},
    'shift_y':      {'prop': 'shift_y', 'sens_jog': config.JOG_SENSITIVITY_SHIFT, 'sens_pm': config.PLUS_MINUS_SENSITIVITY_SHIFT},
    'dof_distance': {'prop': 'dof.focus_distance', 'sens_jog': config.JOG_SENSITIVITY_FOCUS, 'sens_pm': config.PLUS_MINUS_SENSITIVITY_FOCUS, 'min': 0.0},
    'fstop':        {'prop': 'dof.aperture_fstop', 'sens_jog': config.JOG_SENSITIVITY_FSTOP, 'sens_pm': config.PLUS_MINUS_SENSITIVITY_FSTOP, 'min': 0.01},
    'dia_blades':   {'prop': 'dof.aperture_blades', 'sens_jog': config.JOG_SENSITIVITY_BLADES, 'sens_pm': config.PLUS_MINUS_SENSITIVITY_BLADES, 'min': 3, 'type': 'int'},
    'dia_rot':      {'prop': 'dof.aperture_rotation', 'sens_jog': config.JOG_SENSITIVITY_ROTATION, 'sens_pm': config.PLUS_MINUS_SENSITIVITY_ROTATION, 'type': 'rad'},
    'dist_ratio':   {'prop': 'dof.aperture_ratio', 'sens_jog': config.JOG_SENSITIVITY_RATIO, 'sens_pm': config.PLUS_MINUS_SENSITIVITY_RATIO, 'min': 0.01},
}
